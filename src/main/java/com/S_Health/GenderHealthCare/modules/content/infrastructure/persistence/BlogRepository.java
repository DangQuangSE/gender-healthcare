...
public interface BlogRepository extends JpaRepository<Blog, Long> {
    @Query("SELECT new com.S_Health.GenderHealthCare.modules.content.dto.response.BlogSummaryResponse(b.id, b.title, b.viewCount, b.likeCount, COUNT(c.id)) FROM Blog b LEFT JOIN Comment c ON b.id = c.blog.id WHERE b.status = 'PUBLISHED' GROUP BY b.id ORDER BY b.createdAt DESC")
