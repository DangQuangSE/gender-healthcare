...
public class LegacyServiceController {
    ...
    public ResponseEntity<List<ServiceDetailResponse>> getAllServices() {
    ...
    public ResponseEntity<List<ServiceDetailResponse>> searchServicesByName(@RequestParam String name) {
    ...
    public ResponseEntity<List<ServiceDetailResponse>> getServicesBySpecialization(@PathVariable Long specializationId) {
    ...
    public ResponseEntity<ServiceDetailResponse> createService(@Valid @RequestBody ServiceDetailResponse serviceDTO) {
    ...
    public ResponseEntity<ServiceDetailResponse> updateService(
            ...
            @Valid @RequestBody ServiceDetailResponse serviceDTO) {
    ...
    public ResponseEntity<ServiceDetailResponse> activateService(@PathVariable Long id) {
    ...
    public ResponseEntity<ServiceDetailResponse> deactivateService(@PathVariable Long id) {
    ...
    public ResponseEntity<ComboResponse> createComboService(@Valid @RequestBody ServiceDetailResponse serviceDTO) {
